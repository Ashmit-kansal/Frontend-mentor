      ...
      <div className="min-h-screen bg-grey-200 flex items-center justify-center">
        <div className="w-[80%] max-w-[700px] bg-white rounded-lg shadow-lg md:flex">
          ...
          <div className="p-6">
            ...
            <div className={`flex items-center gap-4 mt-10 ${ShowShare ? "hidden md:flex":""}`}>
              <img
              ...
              <button
                ...
                className="ml-auto bg-grey-200 rounded-full p-3"
              >
                <svg
          ...
          {ShowShare && (
  <>
    {/* Share component for md+ screens, positioned above the share icon */}
    <div className="hidden md:flex items-center gap-4 bg-grey-900 p-6 rounded-xl absolute">
      <p className="text-preset3 text-grey-400">SHARE</p>
      <img src={facebookIcon} alt="facebook icon" />
      <img src={twitterIcon} alt="twitter icon" />
      <img src={pinterestIcon} alt="pinterest icon" />
    </div>
    {/* Share component for mobile screens (as before) */}
