        ...
        <div className="p-8 bg-linear-to-b from-gradient-1-from to-gradient-1-to rounded-2xl max-w-[412px] w-11/12">
          {!submitted ? (
            ...
            <div className="flex flex-col items-center text-center">
              <svg
                className="w-[144px] h-[96px] md:w-[162px] md:h-[108px]"
                viewBox="0 0 162 108"
                width="162"
                height="108"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p className="p-2 px-4 bg-grey-900 rounded-3xl text-preset5 md:text-[15px]/[24px] text-orange-500 mt-6">
                You selected {rating} out of 5
              </p>
              <h2 className="text-white my-6 text-preset2 md:text-[28px]/[35px]">
                Thank you!
              </h2>
              <p className="text-grey-500 text-preset5 md:text-[15px]/[24px]">
