        ...
        <div className="h-screen flex items-center justify-center bg-grey-950">
          ...
          <div className="w-11/12 max-w-[540px]">
            ...
            <div className="w-full flex justify-between p-4 bg-grey-800 relative my-4">
              <input className="text-grey-700 text-preset2 focus:outline-none" type="text" readOnly value="GeneratedPassword" />
              <button className="absolute right-5 top-1/2 transform -translate-y-1/2">
                <svg className="fill-current text-green-200 hover:cursor-pointer hover:text-white" width="21" height="24" xmlns="http://www.w3.org/2000/svg">
                  <path
            ...
            <div className="bg-grey-800 p-4 flex flex-col gap-4 text-grey-200 text-preset4">
              ...
              <button className="w-full bg-green-200 text-grey-800 text-preset3 p-3 hover:bg-grey-800 hover:border hover:border-green-200 hover:text-green-200 transition-colors duration-300">
                Generate{" "}
                <svg className="fill-current inline" width="12" height="12" xmlns="http://www.w3.org/2000/svg">
                  <path
